...
foreign lib {
	...
	@(link_name="b2ComputeCosSin")
	compute_cos_sin :: proc(radians: f32) -> Cos_Sin ---

	/// Compute the rotation between two unit vectors
	@(link_name="b2ComputeRotationBetweenUnitVectors")
	compute_rotation_between_unit_vectors :: proc(v1: Vec2, v2: Vec2) -> Rot ---

	/// Is this a valid number? Not NaN or infinity.
	@(link_name="b2IsValidFloat")
	is_valid_float :: proc(a: f32) -> bool ---

	/// Is this a valid vector? Not NaN or infinity.
	@(link_name="b2IsValidVec2")
	is_valid_vec2 :: proc(v: Vec2) -> bool ---

	/// Is this a valid rotation? Not NaN or infinity. Is normalized.
	@(link_name="b2IsValidRotation")
	is_valid_rotation :: proc(q: Rot) -> bool ---

	/// Is this a valid bounding box? Not Nan or infinity. Upper bound greater than or equal to lower bound.
	@(link_name="b2IsValidAABB")
	is_valid_aabb :: proc(aabb: Aabb) -> bool ---
	...
	@(link_name="b2SetLengthUnitsPerMeter")
	set_length_units_per_meter :: proc(lengthUnits: f32) ---

	/// Get the current length units per meter.
	@(link_name="b2GetLengthUnitsPerMeter")
	get_length_units_per_meter :: proc() -> f32 ---
}
